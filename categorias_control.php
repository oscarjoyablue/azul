...
<?php
    ...
    $query_RstCategorias = "SELECT * FROM categorias";
    $RstCategorias = mysqli_query($cnx,$query_RstCategorias) or die(mysql_error());
    $row_RstCategorias = mysqli_fetch_assoc($RstCategorias);
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Lista de Categorías </h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12">	
                            ...
                            <hr /> -->
                            <?php if($totalRows_RstCategorias>0){ ?>
                            <table id="tabla" class="table table-striped table table-bordered table-hover table table-sm">
                                ...
                                <tbody  bgcolor="#FFFFFF">
                                    <?php do { ?>
                                    <tr>
                                        <td><?php echo $row_RstCategorias['idcategoria']; ?></td>
                                        <td><?php echo $row_RstCategorias['categoria']; ?></td>
                                    </tr>
                                    <?php } while ($row_RstCategorias = mysqli_fetch_assoc($RstCategorias)); ?>
                                </tbody>
                            </table>
                            <?php } else { ?>
