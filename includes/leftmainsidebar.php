    ...
    <div class="sidebar-inner leftscroll">
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-area-chart"></i><span> Panel Productos </span> <span class="label radius-circle bg-primary float-right">9</span></a>
                </li>
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-area-chart"></i><span> Panel Entradas </span> <span class="label radius-circle bg-success float-right">9</span></a>
                </li>
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-area-chart"></i><span> Panel Salidas </span> <span class="label radius-circle bg-success float-right">9</span></a>
                </li>
                <!-- <li class="submenu">
                ...
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-tv"></i> <span> Submenus#1 </span> <span class="menu-arrow"></span><span class="label radius-circle bg-secondary float-right">9</span></a>
                    <ul class="list-unstyled">
                        <li><a href="ui-alerts.html">Panel productos</a></li>
                        <li><a href="ui-buttons.html">Panel Entradas</a></li>
                        <li><a href="ui-cards.html">pagina#3</a></li>
                ...
                <!-- <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-file-text-o"></i> <span> Submenus#2 </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="forms-general.html">pagina#1</a></li>
                        <li><a href="forms-select2.html">pagina#2</a></li>
                        <li><a href="forms-validation.html">pagina#3</a></li> -->
                ...
                <li class="submenu">
                    <a href="#"><span class="label radius-circle bg-danger float-right">9</span><i class="fa fa-fw fa-indent"></i><span> Menu Levels </span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a class="pro" href="#"><i class="fa fa-fw fa-star"></i><span> Submenu#3 </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">								
                        <li><a target="_blank" href="#">pagina#1 <!-- <span class="badge alert-success" >1</span> --></a></li>
                ...
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-area-chart"></i><span> Salir </span> <span class="label radius-circle bg-success float-right">9</span></a>
                </li>
            </ul>
